...
const Category = (props) => {
  ...
  const fetchData = async () => {
    const res = await axios.get("/get-property-category");
  ...
  const onclick = async (category) => {
    const fetchData1 = async () => {
      const res = await axios.get("/get-property-category/" + category);
      console.log(res.data);
      return res;
    };
    const res1 = await fetchData1();
    setResults1(res1.data);
  };
  ...
  const applyFilter = async () => {
    ...
    const res = await axios.post("/filter/Kathmandu", options);
    setResults(res.data);
          ...
          <div className="container col-md-12 col-12">
            <div className="row">
              ...
              <div className="col-md-9">
                          ...
                          <div key={ind} className="row">
                              ...
                              <div className="px-2 py-1 text-start mb-3">
                                ...
                                <div className="d-flex justify-content-start align-items-center">
                                  <div className="ms-2 my-1">
                                    {result?.available ? (
                                      <button
                                        className="btn text-sm text-light my-2 btn-sm"
                            ...
                            <div className="col-md-3">
                              <div className="p-1 text-md-end text-start">
                                ...
                                <i
                                  onClick={() => {
                                    setCompare((data) => [...data, result]);
                                    console.log(compare);
                                    if (!show) {
                                      setShow(true);
                                    }
                                  }}
                                  class="fa-solid fa-code-compare my-2 text-primary"
                                ></i>
                                <div className="d-flex justify-content-md-end justify-content-start align-items-center py-0">
                                  <Link
                                    to={`/view-details/${result._id}`}
                ...
                {show && compare.length >= 2 && (
                  <button
                    onClick={() => {
                      nav(`/view-details/${compare[0]?._id}`, {
                        state: { compare: compare },
                      });
                    }}
                    style={{ position: "fixed", top: "93%", right: "15px" }}
