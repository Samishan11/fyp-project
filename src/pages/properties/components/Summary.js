                ...
                <div className='row my-4'>
                    <div className='col-md-6'>
                        <div className='border rounded my-2 px-1 py-2 d-flex'>
                            ...
                            <div>
                                {/* <small className='text-xs'>Step {step}</small> */}
                        ...
                        {
                            listingData?.category === "hotel" || listingData?.category === "hostel" ?
                                <div className='border rounded my-2 px-1 py-2 d-flex'>
                                    <div className='my-auto mx-2'>
                                        <ion-icon name="add-circle-outline" style={{ fontSize: "3em", color: "#1965fc" }}></ion-icon>                            </div>
                                    <div>
                                        {/* <small className='text-xs'>Step {step}{()=>setStep(step++)}</small> */}
                                        <p className='fw-bold m-0'>Add rooms</p>
                                        <small className='text-sm'>Add rooms and its features on this property.</small>
                                        <Link to={`/add-room/${propertyId}/room-details`} className='link-btn link-btn-sm text-primary d-block'>Add new room</Link>
                                    </div>
                                </div> :
                                <></>
                        }
                        ...
                        {/* {
                            listingData?.category !== "room" || listingData?.category === "apartment" ?
                                <> */}
                        <div className='border rounded my-2 px-1 py-2 d-flex'>
                            <div className='my-auto mx-2'>
                                <ion-icon name="image" style={{ fontSize: "3em", color: "#1965fc" }}></ion-icon>                            </div>
                            <div>
                                {/* <small className='text-xs'>Step {step}{()=>setStep(step + 1)}</small> */}
                                ...
                                <Link to={`/list-property/${propertyId}/update/images`} className='link-btn link-btn-sm text-primary d-block'>Upload Images</Link>
                            </div>
                        </div>
                        {/* </> :
                                <></>
